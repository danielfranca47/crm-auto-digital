...
from app.runners.email import execute_job
...
def _parse_types() -> list[str]:
    raw = os.getenv("EMAIL_WORKER_TYPES", "email.send.cold")
...
def main() -> int:
    ...
    types = _parse_types()
    max_jobs = _parse_optional_int("EMAIL_WORKER_MAX_JOBS")
    max_runtime_seconds = _parse_optional_int("EMAIL_WORKER_MAX_RUNTIME_SECONDS")

...
def _build_child_prompt_meeting_management(context: Dict[str, Any], message_text: str) -> str:
    ...
    return (
        ...
        "- Se a mensagem pedir REAGENDAMENTO e JÁ incluir dia E horário (mesmo que tentativo, ex.: "
        "'pode ser domingo às 11h?'): CONFIRME DIRETAMENTE neste turno — preencha "
        "signals_structured.meeting_reschedule_requested=true e meeting_datetime_candidate (ISO, "
        "use tabela_de_dias para resolver datas relativas — NUNCA calcule por conta própria). "

...
export type CollabMonitorInstance = {
  id: number;
  instance_id: string;
...
export type CollabMonitorConnectResponse = {
  id: number;
  instance_id: string;
  collaborator_name: string;
  status?: string | null;
  ...
  agente: {
    ...
    getConfig: async (): Promise<import('../types/agente').AgentConfig> => {
      ...
      return {
        ...
        followup_checkin_auto_trigger_enabled: (profile as any)?.followup_checkin_auto_trigger_enabled ?? DEFAULT_AGENT_CONFIG.followup_checkin_auto_trigger_enabled,
        followup_checkin_inactivity_days: (profile as any)?.followup_checkin_inactivity_days ?? DEFAULT_AGENT_CONFIG.followup_checkin_inactivity_days,
        ...
        followup_checkin_instructions:           (profile as any)?.followup_checkin_instructions           ?? null,
        followup_goal_instructions:             (profile as any)?.followup_goal_instructions             ?? null,
        cart_recovery_attempt_instructions:     (profile as any)?.cart_recovery_attempt_instructions     ?? null,
    ...
    saveConfig: async (config: import('../types/agente').AgentConfig): Promise<void> => {
      ...
      await coreClient.put('/ai-profiles/me', {
        ...
        followup_checkin_auto_trigger_enabled:  config.followup_checkin_auto_trigger_enabled,
        followup_checkin_inactivity_days:       config.followup_checkin_inactivity_days,
        ...
        followup_checkin_instructions:         config.followup_checkin_instructions,
        followup_goal_instructions:            config.followup_goal_instructions,
        cart_recovery_attempt_instructions:    config.cart_recovery_attempt_instructions,
        followup_outcome_instructions:         config.followup_outcome_instructions,
        offer_pack,

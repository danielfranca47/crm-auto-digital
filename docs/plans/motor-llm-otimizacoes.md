...
> mercado. Documentados em detalhe em
> [`docs/architecture/prompt-engineering-principles.md`](../architecture/prompt-engineering-principles.md#9-achados-de-pesquisa-aplicados-ao-nosso-motor-de-llm)
> (seção 9) — este arquivo é o plano de ação, aquele é a referência técnica
> completa com as fontes de mercado citadas.
...
(ver OWASP GenAI LLM01:2025, citado na seção 9.3 da referência técnica).

...
| `followup-proativo-e-cancelamento-agenda.md` | Disparo automático de follow-up por inatividade, correcção de persistência da config no AI Profile e camada dedicada (Híbrido Agendador e SDR) |

...
| Auth endpoints, User model, password reset, email service, rotas públicas do frontend-crm, login sem senha (OTP) e lockout anti-força-bruta | `auth-email.md` |

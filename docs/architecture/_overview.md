...
| Endpoint `POST /api/uploads` (auth, isolamento por usuário, limite de tamanho), resolução de `upload_id` em `/api/assistente-ia/processar`/`/preview` | `leads-schema.md` |

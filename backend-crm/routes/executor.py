...
def _normalize_job(job: Dict[str, Any], *, status_override: Optional[str] = None) -> Dict[str, Any]:
    status_map = {
    ...
    return {
        ...
        "lease_owner": job.get("assigned_agent_id"),
...
def claim_job_internal(
    ...
    return {"job": job, "normalized": _normalize_job(job, status_override=JOB_STATUS_IN_PROGRESS)}

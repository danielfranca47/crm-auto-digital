...
def extract_instance_details(
    ...
    *,
    ...
    instance_id = _first_value(payload, ["instance_id", "instanceId", "id", "instance", "name"]) or _first_value(
        instance_payload, ["instance_id", "instanceId", "id", "instance", "name"]
    )
    if not instance_id and isinstance(instance_field, str):
...
def extract_connection_meta(payload: Dict[str, Any]) -> tuple[Optional[str], Optional[str], Optional[str]]:
    ...
    status_value = _first_value(payload, ["status", "instanceStatus"]) or _first_value(
        instance_payload, ["status", "instanceStatus"]
    )

...
def on_startup() -> None:
    ...
    ensure_whatsapp_connections_table()
    ensure_whatsapp_connections_columns()
    ensure_whatsapp_connections_unique_agent_index()
    ensure_ai_profile_columns()
    ensure_presentation_variant_direto_backfill()
